...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Ariana", "Andrisan", "0733704448", "ariana.andrisan@yahoo.com", "password123", "password123", null)]
        public virtual void SignUpAndLogin(string firstName, string lastName, string mobilePhone, string emailAddress, string userPassword, string userPasswordRepeat, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("userPasswordRepeat", userPasswordRepeat);
...
#line hidden
#line 14
 testRunner.Then("I am successfully logged in with new account", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
